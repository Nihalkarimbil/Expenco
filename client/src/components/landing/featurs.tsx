...
function Features() {
  return (
    <div className="bg-blue-500 h-60 w-full flex items-center justify-between mx-auto px-4 md:px-8 lg:px-28">
        <Link href="/login">
      ...
      <div className="flex flex-col items-center space-y-2 hover:cursor-pointer" >
        ...
        <h1 className="text-lg font-semibold text-gray-100">Plan The Budget</h1>
      </div>
      </Link>
      <Link href="/login">
      <div className="flex flex-col items-center space-y-2 hover:cursor-pointer" >
